...
---
TASKS:
- make the initial animation of animation app go a bit faster.
- menu buttons area is interfering with the orbital controls when the menu is visible. Suggest fixes.
---
