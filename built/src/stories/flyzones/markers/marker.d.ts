...
export declare const createMarker: (position: THREE.Vector3, title: string, description: string, mediaItems: Media[], type: MarkerType, scene: THREE.Scene, popupContainer: HTMLDivElement, navigateTo: (position: THREE.Vector3, location?: Location) => void, location: Location | undefined, camera: THREE.Camera, conditions?: any[]) => Promise<MarkerObject>;
export declare const createPinMesh: (type: MarkerType) => Promise<THREE.Group>;
