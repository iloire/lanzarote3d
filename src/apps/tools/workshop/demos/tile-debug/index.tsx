...
const TileDebugPage: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              ...
              >
                <div>
                  X Range: {calculatedTiles.xMin} → {calculatedTiles.xMax}
                </div>
                <div>
                  Y Range: {calculatedTiles.yMin} → {calculatedTiles.yMax}
                </div>
            ...
            <div>
              ...
              >
                <div>
                  Base:
                  server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/12/Y/X
                </div>
                <div style={{ marginTop: '4px', color: '#666' }}>
                  Example: .../tile/12/1700/1892
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{ fontSize: '14px' }}>
                ...
                <div>
                  Command:{' '}
                  <code
                    style={{ fontSize: '12px', backgroundColor: '#f7fafc', padding: '2px 4px' }}
                  >
                    magick montage -tile 7x8 -geometry +0+0
                  </code>
                </div>
          ...
          {tileMapping && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                ...
                <div style={{ fontSize: '14px', color: '#666' }}>{tileMapping.description}</div>
              </div>
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ fontFamily: 'monospace', fontSize: '12px' }}>
                        U: {selectedTile.uvBounds.uMin.toFixed(3)} →{' '}
                        {selectedTile.uvBounds.uMax.toFixed(3)}
                        <br />
                        V: {selectedTile.uvBounds.vMin.toFixed(3)} →{' '}
                        {selectedTile.uvBounds.vMax.toFixed(3)}
                      </div>
                    </div>
                  </div>
                  <div style={{ marginTop: '8px', fontSize: '12px', color: '#666' }}>
                    Grid Position: Row {getTileGridPosition(selectedTile).row}, Col{' '}
                    {getTileGridPosition(selectedTile).col}
                  </div>
                </div>
              ) : (
                <div
                  style={{ fontSize: '14px', color: '#999', textAlign: 'center', padding: '16px' }}
                >
      ...
      >
        <h3
          style={{ fontSize: '18px', fontWeight: 'bold', marginBottom: '16px', color: '#d63031' }}
        >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          >
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              >
                ❌ Satellite atlas image not found at
                /assets/textures/lanzarote-satellite-atlas-full.jpg
              </div>
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          >
            <div>
              ...
              <div
                style={{ fontSize: '14px', display: 'flex', flexDirection: 'column', gap: '4px' }}
              >
          ...
          >
            ...
            <div style={{ fontSize: '14px', color: '#2d7748' }}>
              ...
              Ready for terrain texture mapping with full island coverage and precise geographic
              alignment.
            </div>
          </div>
        </div>
